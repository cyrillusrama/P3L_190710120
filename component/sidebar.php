    ...
    echo '
        ...
        <body>
            <aside>
                <div class="d-flex">
                    <div class="side-bar">
                        <h2 class="text-light text-center pt-2">ATMA JOGJA RENTAL</h2>
                        <hr>
                        <div class="menu">
                            ...
                            <div class="content-menu">
                                <i class="fa fa-list"></i>
                                <a href="#" style="font-weight:600">List Driver</a>
                            </div>
                            <div class="content-menu">
                                <i class="fa fa-plus-square"></i>
                            ...
                            <div class="content-menu">
                                <i class="fa fa-list"></i>
                                <a href="#" style="font-weight:600">Data Customer</a>
                            </div>
                            <div class="content-menu">
                                <i class="fa fa-plus-square"></i>
                                <a href="#" style="font-weight:600">Add Customer</a>
                            </div>
                            <div class="content-menu">
                                <i class="fa fa-car"></i>
                                <a href="./listAsetPage.php" style="font-weight:600">List Aset Mobil</a>
                            </div>
                            <div class="content-menu">
                                <i class="fa fa-plus-square"></i>
                                <a href="./addAsetPage.php" style="font-weight:600">Add Aset Monil</a>
                            </div>
                            <div class="content-menu">
