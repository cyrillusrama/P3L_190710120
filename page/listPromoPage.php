                ...
                if (mysqli_num_rows($query) == 0) {
                    ...
                    echo'
                        <tr>
                            ...
                            <td>'.$data['besar_diskon_promo'].'</td>
                            <td>'.$data['status_promo'].'</td>
                            <td>
                                 <a href="./editPromo.php?id='.$data['id_promo'].'"><i style="color: green" class="fa fa-edit"></i></a>
                                <a href="../process/deletePromoProcess.php?id='.$data['id_promo'].'" onClick="return confirm ( \'Yakin?\')">
